...
for dataset_name in datasets:
    for model_name in models_names:
        ...
        if 'novo' in dataset_name:
            file_name += 'backup_with_rotz/best_'
        else:
            file_name += 'backup_without_rotz/best_'
        ...
        if 'novo' in dataset_name:
            file_name_save += 'backup_with_rotz/metrics_full_train_'
        else:
            file_name_save += 'backup_without_rotz/metrics_full_train_'
