...
for dataset_name in datasets:
    for model_name in models_names:
        ...
        file_name_save = 'output/models_meta_data/backup_without_rotz/metrics_full_train_' + model_name + '_' + dataset_name + '.json'
